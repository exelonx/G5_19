<?php
    ...
    class Socios extends Conectar{
        ...
        public function insert_socio($nombre, $razon_social, $direccion, $tipo_socio, $contacto, $email, 
        $fecha_creado, $estado, $telefono){

            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO g5_19.ma_socios_negocio(id, nombre, razon_social, direccion, tipo_socio,
            contacto, email, fecha_creado, estado, telefono) VALUES
                (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
            $sql=$conectar -> prepare($sql);
        ...
        public function update_socio($id, $nombre, $razon_social, $direccion, $tipo_socio, $contacto, $email, 
        $fecha_creado, $estado, $telefono)
        {
           
            $conectar= parent::conexion();
            parent::set_names();
            $sql="UPDATE g5_19.ma_socios_negocio 
            SET 
                nombre=?, 
                razon_social=?, 
                direccion=?, 
